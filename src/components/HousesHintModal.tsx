...
const FEATURES: { icon: string; title: string; desc: string }[] = [
  ...
  { icon: 'Pencil', title: 'Управление домом', desc: 'Глава дома может редактировать шапку, описание, добавлять фото и аудио, а также видео по ссылке с YouTube, VK, Rutube или Twitch.' },
